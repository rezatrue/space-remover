				...
				if (file == null) {
					...
					try {
						...
						if (fileName != null) {
							...
							File dir = new File("Space_Removed-files");
							while(dir.exists()) {
								// this method create problem 
//								filemanager.deleteFolder(dir);
								JOptionPane.showMessageDialog(MainFrame.this, "Please remove previous file named \"Space_Removed-files\"", "Warning", JOptionPane.INFORMATION_MESSAGE);
							}
							dir.mkdir();
							
							filemanager.spaceRemover(data, file, dir);
							// send massage : Rename completed
							JOptionPane.showMessageDialog(MainFrame.this, "File Space Removed Completed", "Done", JOptionPane.INFORMATION_MESSAGE);
						} else {
